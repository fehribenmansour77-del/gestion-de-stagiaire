      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/presences" element={
            <ProtectedLayout allowedRoles={['tuteur', 'encadrant', 'chef_departement', 'admin_rh', 'super_admin', 'stagiaire']}>
              <Presences />
            </ProtectedLayout>
          } />
          ...
          <Route path="/dashboard" element={
            <ProtectedLayout allowedRoles={['admin_rh', 'super_admin', 'chef_departement', 'tuteur', 'encadrant']}>
              <Dashboard />
            </ProtectedLayout>
          } />
          <Route path="/notifications" element={
            <ProtectedLayout allowedRoles={['admin_rh', 'super_admin', 'chef_departement', 'tuteur', 'encadrant', 'stagiaire']}>
              <Notifications />
            </ProtectedLayout>
          } />
