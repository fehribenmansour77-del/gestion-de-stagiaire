...
const Candidatures = () => {
  ...
  const handleRecalculateAI = async () => {
    try {
      setLoading(true);
      await api.post('/candidatures/re-match');
      // toast.success('Analyse IA terminée !'); // If toast is available, otherwise alert
             ...
             <div style={{ display: 'flex', gap: 16 }}>
                <button 
                   ...
                   style={{ 
                      ...
                      cursor: 'pointer', transition: '0.3s', fontWeight: 700, fontSize: 13,
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                   <thead>
                      <tr style={{ borderBottom: '1px solid #E2E8F0' }}>
                         ...
                         <th style={{ padding: '24px 20px', textAlign: 'left', fontSize: 11, fontWeight: 900, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Match IA</th>
                         ...
                         >
                            ...
                            <td style={{ padding: '24px 20px' }}>
                               <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                  <div style={{ 
                                     padding: '4px 8px', borderRadius: 8, background: cand.score_matching > 70 ? '#05966915' : cand.score_matching > 40 ? '#D4AF3715' : '#DC262615',
                                     color: cand.score_matching > 70 ? '#059669' : cand.score_matching > 40 ? '#D4AF37' : '#DC2626',
                                     fontSize: 12, fontWeight: 900, display: 'flex', alignItems: 'center', gap: 4
                                  }}>
                                     <Zap size={10} fill={cand.score_matching > 70 ? '#059669' : 'none'} /> {cand.score_matching}%
                                  </div>
                               </div>
                            </td>
                            <td style={{ padding: '24px 20px' }}>
                         ...
                         <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 12 }}>
                            ...
                            <div>
                               ...
                               <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginTop: 8 }}>
                                  ...
                                  <span style={{ fontSize: 10, fontWeight: 900, color: '#D4AF37', background: 'rgba(212,175,55,0.1)', padding: '4px 8px', borderRadius: 8, display: 'flex', alignItems: 'center', gap: 4 }}>
                                     <Zap size={10} fill="#D4AF37" /> IA MATCH: {selectedCandidature.score_matching}%
                                  </span>
                               </div>
                            </div>
                         </div>
