           ...
           <div className="pre-card" style={{ position: 'relative', width: '100%', maxWidth: 500, overflow: 'hidden', boxShadow: '0 50px 100px rgba(0,0,0,0.2)' }}>
              ...
              <form onSubmit={handleSubmitPresence} style={{ padding: 40 }}>
                 ...
                 <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 24 }}>
                    ...
                    <div style={{ marginBottom: 24 }}>
                       <label style={{ fontSize: 11, fontWeight: 900, textTransform: 'uppercase', color: '#001D3D', marginBottom: 8, display: 'block' }}>Motif / Justificatif (Optionnel)</label>
                       <input type="text" placeholder="Ex: Congé maladie, Retard transport..." style={{ width: '100%', padding: '14px', border: '1px solid #E2E8F0', borderRadius: 14, fontWeight: 600 }} value={newPresence.justificatif} onChange={e => setNewPresence({...newPresence, justificatif: e.target.value})} />
                    </div>
                 </div>
