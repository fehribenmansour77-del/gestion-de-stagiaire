...
// POST/GET /api/dashboard/export/excel - Export Excel
router.all('/export/excel', authenticate, authorize(['admin_rh', 'super_admin']), async (req, res) => {
  try {
    const type = req.body.type || req.query.type || 'stagiaires';
...
// POST/GET /api/dashboard/export/pdf - Export PDF
router.all('/export/pdf', authenticate, authorize(['admin_rh', 'super_admin']), async (req, res) => {
  try {
    const type = req.body.type || req.query.type || 'rapport';
