  ...
  async (req, res, next) => {
    try {
      ...
      await departement.update({
        ...
        parent_id: parent_id !== undefined ? (parent_id === "" ? null : parent_id) : departement.parent_id,
        capacite_accueil: capacite_accueil !== undefined ? capacite_accueil : departement.capacite_accueil,
        responsable_id: responsable_id !== undefined ? (responsable_id === "" ? null : responsable_id) : departement.responsable_id,
