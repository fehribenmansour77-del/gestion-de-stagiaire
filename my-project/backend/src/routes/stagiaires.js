  ...
  async (req, res, next) => {
    try {
      ...
      const stagiaire = await Stagiaire.create({
        ...
        annee_en_cours: annee_en_cours || null,
        departement_id: departement_id || null,
  ...
  async (req, res, next) => {
    try {
      ...
      await stagiaire.update({
        etablissement: etablissement !== undefined ? (etablissement || null) : stagiaire.etablissement,
        filiere: filiere !== undefined ? (filiere || null) : stagiaire.filiere,
        niveau_etude: niveau_etude !== undefined ? (niveau_etude || null) : stagiaire.niveau_etude,
        annee_en_cours: annee_en_cours !== undefined ? (annee_en_cours || null) : stagiaire.annee_en_cours,
        departement_id: departement_id !== undefined ? (departement_id || null) : stagiaire.departement_id,
        tuteur_id: tuteur_id !== undefined ? (tuteur_id || null) : stagiaire.tuteur_id,
        date_demarrage: date_demarrage !== undefined ? (date_demarrage || null) : stagiaire.date_demarrage,
        date_fin: date_fin !== undefined ? (date_fin || null) : stagiaire.date_fin,
        entity: entity !== undefined ? (entity || null) : stagiaire.entity
      });
      
      // Si le département change, mettre à jour l'utilisateur aussi
      if (departement_id !== undefined && (departement_id || null) !== stagiaire.departement_id) {
